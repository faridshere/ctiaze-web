...
type Dict = {
  ...
  footer: { tagline: string; about: string; glossary: string; guides: string; sectors: string; vendors: string };
...
const az: Dict = {
  ...
  footer: { tagline: "~60 mənbə → AI qiymətləndirmə və yoxlama → Azərbaycan dilində. 24/7, insan müdaxiləsi olmadan.", about: "haqqında", glossary: "lüğət", guides: "hücum növləri", sectors: "sektorlar", vendors: "vendorlar" },
...
const en: Dict = {
  ...
  footer: { tagline: "~60 sources → AI scoring and verification → in Azerbaijani. 24/7, no human in the loop.", about: "about", glossary: "glossary", guides: "attack types", sectors: "sectors", vendors: "vendors" },
