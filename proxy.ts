...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|news-sitemap.xml|api/|feed.json|rss.xml|llms.txt|opengraph-image|icon.svg|google[0-9a-f]+\\.html).*)",
  ],
};
