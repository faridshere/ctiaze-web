  ...
  return (
    <section id="api" className="border-t border-hairline bg-[linear-gradient(180deg,transparent,rgba(255,255,255,0.012),transparent)]">
      <div className="mx-auto grid w-full max-w-[75rem] grid-cols-1 items-center gap-[clamp(30px,5vw,64px)] px-[var(--sp-gutter)] py-[clamp(46px,7vw,90px)] md:grid-cols-[1.05fr_1.15fr]">
        ...
        <div className="overflow-hidden rounded-[12px] border border-white/[0.15] bg-[linear-gradient(180deg,#0F121A,#0B0D13)] shadow-[0_40px_90px_-50px_rgba(0,0,0,0.9)]">
  ...
  return (
    <section id="edge" className="border-t border-hairline">
      <div className="mx-auto grid w-full max-w-[75rem] grid-cols-1 items-center gap-[clamp(30px,5vw,60px)] px-[var(--sp-gutter)] py-[clamp(46px,7vw,90px)] md:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="overflow-hidden rounded-[12px] border border-hairline bg-[#0B0D13]">
  ...
  return (
    <section id="watch" className="border-t border-hairline">
      <div className="mx-auto grid w-full max-w-[75rem] grid-cols-1 items-center gap-[clamp(28px,4vw,50px)] px-[var(--sp-gutter)] py-[clamp(46px,7vw,90px)] md:grid-cols-[1.3fr_0.9fr]">
        <div className="group relative aspect-video cursor-pointer overflow-hidden rounded-[12px] border border-white/[0.15]" style={{ background: "radial-gradient(90% 120% at 72% 18%, rgba(255,90,31,0.2), transparent 55%), linear-gradient(160deg,#181019,#08090d)" }}>
          <div className="absolute inset-0 opacity-50" style={{ backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(0,0,0,0.14) 4px)" }} />
          ...
          <div className="absolute inset-x-4 bottom-3.5 font-mono text-[0.72rem] text-[#9AA6B4]"><b className="font-normal text-[#EDF1F6]">Carbanak — {en ? "the billion-dollar heist" : "milyard dollarlıq soyğun"}</b> · {en ? "a HACKXANA film" : "HACKXANA filmi"} · 28 {en ? "min" : "dəq"}</div>
        </div>
        <div>
          <h2 className="font-display text-[clamp(1.6rem,2.7vw,2.2rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-[#EDF1F6]">{en ? "The intelligence, told as a story." : "Kəşfiyyat — hekayə kimi danışılır."}</h2>
  ...
  return (
    <section className="relative overflow-hidden border-t border-hairline text-center">
      ...
      <div className="relative mx-auto w-full max-w-[75rem] px-[var(--sp-gutter)] py-[clamp(56px,8vw,110px)]">
        <h2 className="font-display text-[clamp(1.9rem,3.6vw,2.8rem)] font-semibold leading-[1.05] tracking-[-0.025em] text-[#EDF1F6]">{en ? "Point your stack at the wire." : "Stack-ini xəttə yönəlt."}</h2>
        <p className="mx-auto mt-4 max-w-[34rem] text-[1.06rem] text-[#9AA6B4]">{en ? "A key takes a minute, the first 1,000 calls are free, and there's no sales call between you and the data." : "Açar bir dəqiqə çəkir, ilk 1,000 sorğu pulsuzdur və səninlə data arasında satış zəngi yoxdur."}</p>
