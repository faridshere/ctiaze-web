...
// desktop, so its marks are md-only.
      ...
      {cells.map((c, i) => {
        ...
        return (
          ...
          >
            ...
            <dd className="mt-3 font-display text-[clamp(2.2rem,4.5vw,3.4rem)] font-semibold leading-none tracking-[-0.04em] tabular-nums text-ink-primary">
